...
<ul class="menu align-center">
	<li><a href="#section-1" title="解決事例">解決事例</a></li>
...
<section id="section-1" class="section--lp" data-magellan-target="section-1">
	<div class="row align-middle contents">
		<h2 class="column small-12">顧問契約で予防できます！<br>企業法務の解決事例</h2>
		<div class="column small-12">
		<div class="voices accordion column small-12" data-accordion>
		<?php
			include_once( ABSPATH . WPINC . '/feed.php' );
			$rss = fetch_feed( 'https://www.law-yamashita.com/feed/?post_type=cases&cases-cat=corporation' );
			if ( ! is_wp_error( $rss ) ) {
		...
		?>
				<article class="accordion-item" data-accordion-item>
					<a class="accordion-title"><?php echo $item->get_title(); ?></a>
...
<section class="cta--lp --komon">
	<div class="row align-middle">
		<div class="column small-12 medium-9 large-10">
			...
			<p class="cta--lp__desc">ああああああああああああああああああ</p>
		</div>
		<div class="column small-12 medium-3 large-2 text-center"><img src="<?php echo get_template_directory_uri(),  '/assets/img/lp/mitsumori-free.png'; ?>"
					alt="顧問契約のメリットや対応範囲など無料でご説明します。"></div>
...
<div class="row contents">
	<h2 class="jiko-section_title column small-12">顧問契約で予防できます！<br>企業法務の解決事例</h2>
